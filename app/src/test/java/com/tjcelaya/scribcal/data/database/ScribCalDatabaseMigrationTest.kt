 ...
 * ScribCalDatabase.ALL_MIGRATIONS run against it.
 *
...
class ScribCalDatabaseMigrationTest {
    ...
    private var database: ScribCalDatabase? = null
    ...
    private fun openWithMigrations(): ScribCalDatabase =
        Room.databaseBuilder(context, ScribCalDatabase::class.java, DB_NAME)
            .addMigrations(*ScribCalDatabase.ALL_MIGRATIONS)
            .build()
            .also { database = it }
}
