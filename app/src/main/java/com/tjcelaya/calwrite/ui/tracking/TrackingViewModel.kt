...
class TrackingViewModel(
    ...
    val futureEventsWithTypes: LiveData<List<com.tjcelaya.calwrite.ui.tracking.FutureEventWithType>> = MediatorLiveData<List<com.tjcelaya.calwrite.ui.tracking.FutureEventWithType>>().apply {
        var eventTypesList: List<EventType> = emptyList()
        ...
        fun update() {
            ...
            value = futureEventsList.mapNotNull { futureEvent ->
                eventTypesMap[futureEvent.eventTypeId]?.let { eventType ->
                    com.tjcelaya.calwrite.ui.tracking.FutureEventWithType(futureEvent, eventType)
                }
            }
        }
