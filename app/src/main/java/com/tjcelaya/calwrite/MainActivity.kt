...
class MainActivity : AppCompatActivity() {
    ...
    private val app by lazy { application as CalWriteApplication }
    ...
    private fun buildDetailedErrorMessage(enabledButNotHealthy: List<String>, isDriveEnabled: Boolean, isPhotosEnabled: Boolean): String {
        ...
        sb.append("To share photos to CalWrite, you need at least one photo storage service properly configured.\n\n")

        if (enabledButNotHealthy.isNotEmpty()) {
            sb.append("Issues found:\n")

            if (enabledButNotHealthy.contains("Google Photos")) {
                sb.append("\u2022 Google Photos: No album selected for storing CalWrite photos\n")
