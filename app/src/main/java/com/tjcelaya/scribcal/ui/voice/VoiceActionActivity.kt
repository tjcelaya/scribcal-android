...
import com.tjcelaya.scribcal.voice.VoiceActionType
import com.tjcelaya.scribcal.voice.VoiceFollowUp
import com.tjcelaya.scribcal.voice.VoiceIntentParser
import com.tjcelaya.scribcal.voice.VoiceRequest
import com.tjcelaya.scribcal.voice.VoiceUndo
import kotlinx.coroutines.launch

/**
 * Where every voice action lands: an Assistant capability intent, a launcher shortcut, or a
 * `scribcal://action/…` deep link from adb or an automation app.
 *
