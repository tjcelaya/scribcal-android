...
- [ ] Package name exactly matches: `com.tjcelaya.scribcal`
...
2. **Revoke app permissions** in your Google Account:
   ...
   - Find "ScribCal" (or your app name)
   - Click "Remove access"
3. **Clear app data** on your device:
   - Settings > Apps > ScribCal > Storage > Clear Data
...
**Fix:** Ensure package name is exactly `com.tjcelaya.scribcal`
...
**App Package:** `com.tjcelaya.scribcal`
